...
namespace SPF.Web
{
    public class XmlWebSourceContent<T> : WebSourceContent<T>
    {
        ...
        public string GetSubmitResponseString()
        {
        ...
        /// <returns></returns>
        private string outputRawData(byte[] rawData)
        {
            return UTF8Encoding.UTF8.GetString(rawData);
        }
